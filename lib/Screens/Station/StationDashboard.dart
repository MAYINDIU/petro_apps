...
class StationDashboardIconData {
  final String iconPath;
  final String title;
  const StationDashboardIconData(this.iconPath, this.title);
}
...
class _StationDashboardState extends State<StationDashboard> {
  ...
  final List<StationDashboardIconData> dashboardItems = const [
    StationDashboardIconData('assets/icons/qr.png', 'Scan Driver'),
    StationDashboardIconData('assets/icons/gas-pump.png', 'Fuel Entry'),
    StationDashboardIconData('assets/icons/create.png', 'Create Settlement'),
    StationDashboardIconData(
      'assets/icons/report_summary.png',
      'Report Summary',
    ),
    StationDashboardIconData('assets/icons/report.png', 'Daily Report'),
  ];
            ...
            Padding(
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: AssetImage(_assetProfileIconPath),
                        ),
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                _userRole == 'AGENT' ? 'Station' : _userRole,
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 12,
                                ),
                  ...
                  _buildUserInfoRow(Icons.email_outlined, _userEmail),
                  const SizedBox(height: 8),
                  _buildUserInfoRow(Icons.phone_android, _userMobile),
                ],
              ),
            ),
          ],
              ...
              child: Column(
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      _onItemTapped('Create Settlement');
                    },
                  ),
                  ListTile(
                    leading: const Icon(
                    ...
                    onTap: () {
                      Navigator.pop(context);
                      _onItemTapped('Report Summary');
                    },
                  ),
                  ListTile(
                    leading: const Icon(Icons.today, color: kPrimaryDarkBlue),
                    title: const Text(
                      'Daily Report',
                      style: TextStyle(color: kTextColorDark),
                    ),
...
class _AnimatedGridItem extends StatefulWidget {
  final StationDashboardIconData item;
  final int index;
