...
class TotalBusinessYearlyScreen extends StatefulWidget {
  const TotalBusinessYearlyScreen({Key? key}) : super(key: key);

  @override
  _TotalBusinessYearlyScreenState createState() =>
...
class _TotalBusinessYearlyScreenState
  ...
  Future<void> getResponseFormApi() async {
    setState(() {
      isLoading = true;
      _businessData.clear();
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  _buildYearTab("CURRENT YEAR", true),
                                  _buildYearTab("PREVIOUS YEAR", false),
                                ],
                              ),
                            ),
                          ),
  ...
  Widget _buildYearTab(String title, bool isSelected) {
    return Expanded(
      child: GestureDetector(
        onTap: () => setState(() => isCurrentYear = isSelected),
        child: Container(
